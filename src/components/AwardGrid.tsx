        ...
        {awards.map((award, index) => {
          ...
          return (
            <AwardElement 
              ...
              onMouseEnter={(e) => {
                if (hasLink) {
                  (e.currentTarget as HTMLElement).style.filter = 'brightness(0.8) contrast(1) saturate(0.8)';
                }
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLElement).style.filter = 'brightness(0.4) contrast(1.1) saturate(0.6)';
              }}
            >
              <img 
                src={award.src} 
