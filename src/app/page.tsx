...
const getContent = (activeSection: number): Record<string, React.ReactElement> => ({
  tldr: (
    <div style={{ maxWidth: '480px', padding: '0 20px' }}>
      <AnimatedText delay={80} sectionIndex={0} isActive={activeSection === 0}>
  ...
  free: (
    <div style={{ maxWidth: '480px', padding: '0 20px' }}>
      <AnimatedText delay={80} sectionIndex={1} isActive={activeSection === 1}>
        <p style={{ fontSize: '1.125rem', lineHeight: '1.6' }} className="text-white lowercase text-left">
  ...
  snap: (
    <div style={{ maxWidth: '480px', padding: '0 20px' }}>
      <AnimatedText delay={80} sectionIndex={2} isActive={activeSection === 2}>
        <p style={{ fontSize: '1.125rem', lineHeight: '1.6' }} className="text-white lowercase text-left">
  ...
  tribe: (
    <div style={{ maxWidth: '480px', padding: '0 20px' }}>
      <AnimatedText delay={80} sectionIndex={3} isActive={activeSection === 3}>
        <p style={{ fontSize: '1.125rem', lineHeight: '1.6' }} className="text-white lowercase text-left">
  ...
  hustle: (
    <div style={{ maxWidth: '480px', padding: '0 20px' }}>
      <AnimatedText delay={80} sectionIndex={4} isActive={activeSection === 4}>
        <p style={{ fontSize: '1.125rem', lineHeight: '1.6' }} className="text-white lowercase text-left">
  ...
  lost: (
    <div style={{ maxWidth: '480px', padding: '0 20px' }}>
      <AnimatedText delay={80} sectionIndex={5} isActive={activeSection === 5}>
        <p style={{ fontSize: '1.125rem', lineHeight: '1.6' }} className="text-white lowercase text-left">
  ...
  kid: (
    <div style={{ maxWidth: '480px', padding: '0 20px' }}>
      <AnimatedText delay={80} sectionIndex={6} isActive={activeSection === 6}>
        <p style={{ fontSize: '1.125rem', lineHeight: '1.6' }} className="text-white lowercase text-left">
  ...
  social: (
    <div style={{ maxWidth: '480px', padding: '0 20px' }}>
      <AnimatedText delay={80} sectionIndex={7} isActive={activeSection === 7}>
        <p style={{ fontSize: '1.125rem', lineHeight: '1.6' }} className="text-white lowercase text-left">
          DMs are opened on{" "}
          <a href="https://twitter.com/laurentdelrey" target="_blank" rel="noopener noreferrer" 
