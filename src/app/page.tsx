...
const sections = [
  { id: "tldr", label: "TL;DR", years: "", location: [-74.006, 40.7128] as [number, number], zoom: 12 }, // NYC
  { id: "free", label: "free ideas", years: "apr '21 - Today", location: [-122.4194, 37.7749] as [number, number], zoom: 13 }, // San Francisco
  { id: "snap", label: "Snap, Inc.", years: "Sep '18 - sep '23", location: [-118.4912, 34.0195] as [number, number], zoom: 12.5 }, // Santa Monica/LA
  ...
  { id: "social", label: "@ Me", years: "Anytime", location: [-74.006, 40.7128] as [number, number], zoom: 13.5 }, // NYC
];
